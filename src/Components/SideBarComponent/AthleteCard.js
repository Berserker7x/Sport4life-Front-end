...
export default function AthleteCard() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8082/athlete/athletes/${city}`, {
        headers: {
  ...
  return (
    <div>
          ...
          <div class="p-5">
            <a href="#">
              <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                Username : {athleteList[index].username}
              </h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
              City :{athleteList[index].ville}{" "}
            </p>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
              Sport :{athleteList[index].sport}
            </p>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
              Tel :{athleteList[index].tele}
            </p>
            ...
            <div className="flex">
              <div>
                ...
                >
                  ...
                  <p className="ml-2">
                    Instagram : {athleteList[index].instagram}{" "}
                  </p>
                </a>
              </div>
              <div className="ml-5">
                ...
                >
                  ...
                  <p className="ml-2">
                    Facebook: {athleteList[index].facebook}
                  </p>
                </a>
              </div>
            </div>
      ...
      <div className="flex justify-center mt-5">
        ...
        <button
          onClick={() => nextPerson()}
          className="ml-5 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Next
          <svg
            xmlns="http://www.w3.org/2000/svg"
