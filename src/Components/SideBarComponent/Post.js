  ...
  return (
    <div>
      ...
      {myData.map((data,index) => (
              ...
              <div class="px-5 pb-5">
                <button className="text-white bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-orange-400 dark:hover:bg-orange-600 dark:focus:ring-orange-800"> Athlete asking : {(data.userCreatPost?.["username"])}</button>
              <div className="text-center">
           
              <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Tile : {data.title}</h5>
              
              </div>
                <div>
                <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Content : {data.question}</p>
                </div>
                  <div class="flex items-center justify-between">
                      <div className="flex">
                      <button className="w-8 h-5"><img src={ Like[index] ? like_false :like_true}   onClick={handleClick(index)}   /></button>
                      ...
                      <button onClick={()=>setshowAllcoment(true)} class="text-2xl ml-5 font-bold text-gray-900 dark:text-white">Coments</button>
                      </div>
                      <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{(data.userCreatPost?.["sport"])}</a>
